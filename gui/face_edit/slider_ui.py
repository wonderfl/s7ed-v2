...
class SliderUIMixin:
    ...
    # Helper creation methods extracted to avoid duplication across tabs
    def _create_eye_tab_eye_slider(
        self,
        parent,
        label_text,
        variable,
    ...
    def _create_eye_tab_eye_position_x_slider(
        self,
        parent,
        label_text,
        variable,
    ...
    def _create_eye_tab_eye_position_y_slider(
        self,
        parent,
        label_text,
        variable,
    ...
    def _create_eye_tab_eye_region_slider(
        self,
        parent,
        label_text,
        variable,
    ...
    def _create_mouth_tab_generic_slider(
        self,
        parent,
        label_text,
        variable,
    ...
    def _create_mouth_tab_lip_region_slider(
        self,
        parent,
        label_text,
        variable,
    ...
    def _create_eye_tab(self, notebook):
        ...
        self.left_eye_region_padding_label = self._create_eye_tab_eye_region_slider(
            eye_region_frame,
            "왼쪽 영역크기:",
            self.left_eye_region_padding,
            0.0,
            1.0,
            0.01,
            "30%",
        ...
        self.left_eye_region_offset_x_label = self._create_eye_tab_eye_region_slider(
            eye_region_frame,
            "왼쪽 영역수평:",
            self.left_eye_region_offset_x,
            -20.0,
            20.0,
            1.0,
            "0",
        ...
        self.left_eye_region_offset_y_label = self._create_eye_tab_eye_region_slider(
            eye_region_frame,
            "왼쪽 영역수직:",
            self.left_eye_region_offset_y,
            -20.0,
            20.0,
            1.0,
            "0",
        ...
        self.right_eye_region_padding_label = self._create_eye_tab_eye_region_slider(
            eye_region_frame,
            "오른쪽 영역크기:",
            self.right_eye_region_padding,
            0.0,
            1.0,
            0.01,
            "30%",
        ...
        self.right_eye_region_offset_x_label = self._create_eye_tab_eye_region_slider(
            eye_region_frame,
            "오른쪽 영역수평:",
            self.right_eye_region_offset_x,
            -20.0,
            20.0,
            1.0,
            "0",
        ...
        self.right_eye_region_offset_y_label = self._create_eye_tab_eye_region_slider(
            eye_region_frame,
            "오른쪽 영역수직:",
            self.right_eye_region_offset_y,
            -20.0,
            20.0,
            1.0,
            "0",
        ...
        self.left_eye_size_label = self._create_eye_tab_eye_slider(
            eye_shape_frame,
            "왼쪽 눈 크기:",
            self.left_eye_size,
            0.5,
        ...
        self.right_eye_size_label = self._create_eye_tab_eye_slider(
            eye_shape_frame,
            "오른쪽 눈 크기:",
            self.right_eye_size,
            0.5,
        ...
        self.left_eye_position_y_label = self._create_eye_tab_eye_position_y_slider(
            eye_shape_frame,
            "왼쪽 눈 수직:",
            self.left_eye_position_y,
            -10.0,
            10.0,
            1.0,
            "0",
        ...
        self.right_eye_position_y_label = self._create_eye_tab_eye_position_y_slider(
            eye_shape_frame,
            "오른쪽 눈 수직:",
            self.right_eye_position_y,
            -10.0,
            10.0,
            1.0,
            "0",
        ...
        self.left_eye_position_x_label = self._create_eye_tab_eye_position_x_slider(
            eye_shape_frame,
            "왼쪽 눈 수평:",
            self.left_eye_position_x,
            -10.0,
            10.0,
            1.0,
            "0",
        ...
        self.right_eye_position_x_label = self._create_eye_tab_eye_position_x_slider(
            eye_shape_frame,
            "오른쪽 눈 수평:",
            self.right_eye_position_x,
            -10.0,
            10.0,
            1.0,
            "0",
    ...
    def _create_mouth_tab(self, notebook):
        ...
        self.upper_lip_region_padding_x_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "윗입술 영역가로:",
            self.upper_lip_region_padding_x,
            -1.0,
            2.0,
            0.01,
            "20%",
        ...
        self.upper_lip_region_padding_y_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "윗입술 영역세로:",
            self.upper_lip_region_padding_y,
            -1.0,
            2.0,
            0.01,
            "30%",
        ...
        self.upper_lip_region_offset_x_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "윗입술 영역수평:",
            self.upper_lip_region_offset_x,
            -50.0,
            50.0,
            1.0,
            "0",
        ...
        self.upper_lip_region_offset_y_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "윗입술 영역수직:",
            self.upper_lip_region_offset_y,
            -50.0,
            50.0,
            1.0,
            "0",
        ...
        self.lower_lip_region_padding_x_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "아래입술 영역가로:",
            self.lower_lip_region_padding_x,
            -1.0,
            2.0,
            0.01,
            "20%",
        ...
        self.lower_lip_region_padding_y_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "아래입술 영역세로:",
            self.lower_lip_region_padding_y,
            -1.0,
            2.0,
            0.01,
            "30%",
        ...
        self.lower_lip_region_offset_x_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "아래입술 영역수평:",
            self.lower_lip_region_offset_x,
            -50.0,
            50.0,
            1.0,
            "0",
        ...
        self.lower_lip_region_offset_y_label = self._create_mouth_tab_lip_region_slider(
            lip_region_frame,
            "아래입술 영역수직:",
            self.lower_lip_region_offset_y,
            -50.0,
            50.0,
            1.0,
            "0",
        ...
        self.upper_lip_shape_label = self._create_mouth_tab_generic_slider(
            lip_shape_frame,
            "윗입술 모양:",
            self.upper_lip_shape,
            0.2,
            4.0,
            0.01,
            "100%",
        ...
        self.lower_lip_shape_label = self._create_mouth_tab_generic_slider(
            lip_shape_frame,
            "아랫입술 모양:",
            self.lower_lip_shape,
            0.2,
            4.0,
            0.01,
            "100%",
        ...
        self.upper_lip_width_label = self._create_mouth_tab_generic_slider(
            lip_shape_frame,
            "윗입술 너비:",
            self.upper_lip_width,
            0.2,
            4.0,
            0.01,
            "100%",
        ...
        self.lower_lip_width_label = self._create_mouth_tab_generic_slider(
            lip_shape_frame,
            "아랫입술 너비:",
            self.lower_lip_width,
            0.2,
            4.0,
            0.01,
            "100%",
        ...
        self.upper_lip_vertical_move_label = self._create_mouth_tab_generic_slider(
            lip_shape_frame,
            "윗입술 수직 이동:",
            self.upper_lip_vertical_move,
            -50.0,
            50.0,
            1.0,
            "0",
        ...
        self.lower_lip_vertical_move_label = self._create_mouth_tab_generic_slider(
            lip_shape_frame,
            "아랫입술 수직 이동:",
            self.lower_lip_vertical_move,
            -50.0,
            50.0,
            1.0,
            "0",
