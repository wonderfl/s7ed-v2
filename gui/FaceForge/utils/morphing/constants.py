...
try:
    from gui.FaceForge.utils.landmarks import detect_face_landmarks, get_key_landmarks, is_available as landmarks_available
...
print(f"_cv2_cuda_available: {_cv2_cuda_available}")
